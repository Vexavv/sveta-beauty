    ...
    return (
        <div className={styles.About}>
            ...
            <div className={styles.AboutText}>
                <p>
                    Привіт! Я - майстер краси Світлана! Вже понад 15 років я працюю в індустрії краси, у нашій студії
                    ...
                    ваших  губ, надам догляд і красу вашим рукам! У нашій студії тепло, світло і затишно, тут ви
